...
public class DMThreadCustomList extends ListField {
	...
	public DMThreadCustomList (Vector content) {
	    this._data = content;
	...
	*/
		...
		public void drawListRow(ListField list, Graphics g, int index, int y, int w) {
			...
			//draw date	
			g.setFont(dateFont);
			g.drawText(tweet.getTweetDate(), d.timeX , d.timeY, DrawStyle.RIGHT, d.timeW );
		...
		public int getCurrentPosition() {
		  ...
		  public void insert(BaseTweet toInsert, int index) {
		    ...
		    // update the view
		    DMThreadCustomList.this.insert(index);
		  }
		  ...
		  public void delete(int index) {
		    ...
		    // update the view
		    DMThreadCustomList.this.delete(index);
		  }
		  ...
		  public void modify(BaseTweet newValue, int index) {
		    ...
		    // update the view
		    DMThreadCustomList.this.invalidate(index);
		  }
