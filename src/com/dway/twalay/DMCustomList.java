...
public class DMCustomList extends ListField {
	...
	public DMCustomList (Vector content) {
	    this._data = content;
	...
	*/
		...
		public int getCurrentPosition() {
		  ...
		  public void insert(BaseTweet toInsert, int index) {
		    ...
		    // update the view
		    DMCustomList.this.insert(index);
		  }
		  ...
		  public void delete(int index) {
		    ...
		    // update the view
		    DMCustomList.this.delete(index);
		  }
		  ...
		  public void modify(BaseTweet newValue, int index) {
		    ...
		    // update the view
		    DMCustomList.this.invalidate(index);
		  }
